...
class Eloop():
    ...
    def create_task(gen, core=0, name=None, previous_task=None, pause=False, on_cancel=None,
        ...
        return Edas(gen, core=core, name=name, previous_task=previous_task, pause=pause, on_cancel=on_cancel,
