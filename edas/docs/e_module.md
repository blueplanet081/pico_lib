...
- [1. 　class Edas()](#1-class-edas)
  ...
  - [1.18. 　show\_edas()　動作中のタスクの一覧を表示するユーティリティメソッド（クラスメソッド）](#118-show_edas動作中のタスクの一覧を表示するユーティリティメソッドクラスメソッド)
  - [1.19. 　stop\_edas()　動作中のタスクを終了するユーティリティメソッド（クラスメソッド）](#119-stop_edas動作中のタスクを終了するユーティリティメソッドクラスメソッド)
  - [1.20. 　付録](#120-付録)
    - [1.20.1. 　付録１　トレース情報出力レベル](#1201-付録１トレース情報出力レベル)
    - [1.20.2. 　付録２　タスクの状態](#1202-付録２タスクの状態)
    - [1.20.3. 　付録３　タスクの性質](#1203-付録３タスクの性質)
...
### 1.18. 　show_edas()　動作中のタスクの一覧を表示するユーティリティメソッド（クラスメソッド）
...
### 1.19. 　stop_edas()　動作中のタスクを終了するユーティリティメソッド（クラスメソッド）
